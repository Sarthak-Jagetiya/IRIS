...
const Event2 = () => {
  ...
  const validate = () => {
    ...
    ["leader_prn", "member2_prn", "member3_prn", "member4_prn"].forEach(
      (key) => {
    ...
    ["leader_phone", "member2_phone", "member3_phone", "member4_phone"].forEach(
      (key) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      const firstErrorField = document.querySelector(
        `input[name="${Object.keys(newErrors)[0]}"]`
      );
      if (firstErrorField) {
      ...
      <main>
        ...
        <div className="checkout-box">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {errors.team_name && (
              <div className="error-text">{errors.team_name}</div>
            )}
            <input
              type="text"
              name="team_name"
            ...
            <h3>Leader:</h3>
            {errors.leader_name && (
              <div className="error-text">{errors.leader_name}</div>
            )}
            <input
              type="text"
              name="leader_name"
            ...
            />
            {errors.leader_phone && (
              <div className="error-text">{errors.leader_phone}</div>
            )}
            <input
              type="tel"
              name="leader_phone"
            ...
            />
            {errors.leader_email && (
              <div className="error-text">{errors.leader_email}</div>
            )}
            <input
              type="email"
              name="leader_email"
            ...
            />
            {errors.leader_prn && (
              <div className="error-text">{errors.leader_prn}</div>
            )}
            <input
              type="text"
              name="leader_prn"
            ...
            <h3>Member 2:</h3>
            {errors.member2_name && (
              <div className="error-text">{errors.member2_name}</div>
            )}
            <input
              type="text"
              name="member2_name"
            ...
            {errors.member2_phone && (
              <div className="error-text">{errors.member2_phone}</div>
            )}
            <input
              type="tel"
              name="member2_phone"
            ...
            {errors.member2_email && (
              <div className="error-text">{errors.member2_email}</div>
            )}
            <input
              type="email"
              name="member2_email"
            ...
            />
            {errors.member2_prn && (
              <div className="error-text">{errors.member2_prn}</div>
            )}
            <input
              type="text"
              name="member2_prn"
            ...
            <h3>Member 3:</h3>
            {errors.member3_name && (
              <div className="error-text">{errors.member3_name}</div>
            )}
            <input
              type="text"
              name="member3_name"
              ...
              placeholder="Name"
            />
            {errors.member3_phone && (
              <div className="error-text">{errors.member3_phone}</div>
            )}
            <input
              type="tel"
              name="member3_phone"
              ...
              placeholder="Phone Number"
            />
            {errors.member3_email && (
              <div className="error-text">{errors.member3_email}</div>
            )}
            <input
              type="email"
              name="member3_email"
            ...
            />
            {errors.member3_prn && (
              <div className="error-text">{errors.member3_prn}</div>
            )}
            <input
              type="text"
              name="member3_prn"
            ...
            <h3>Member 4:</h3>
            {errors.member4_name && (
              <div className="error-text">{errors.member4_name}</div>
            )}
            <input
              type="text"
              name="member4_name"
              ...
              placeholder="Name"
            />
            {errors.member4_phone && (
              <div className="error-text">{errors.member4_phone}</div>
            )}
            <input
              type="tel"
              name="member4_phone"
              ...
              placeholder="Phone Number"
            />
            {errors.member4_email && (
              <div className="error-text">{errors.member4_email}</div>
            )}
            <input
              type="email"
              name="member4_email"
            ...
            />
            {errors.member4_prn && (
              <div className="error-text">{errors.member4_prn}</div>
            )}
            <input
              type="text"
              name="member4_prn"
